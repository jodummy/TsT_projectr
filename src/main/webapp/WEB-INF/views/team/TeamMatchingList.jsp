...
function insertMessage2(tst_team_no){
	   let myTeamNo = $('#myTeamNo').val();
	   $.ajax({
			async : true,
			url : '${pageContext.request.contextPath}/insertMessageC?tst_team_no='+tst_team_no +"&myTeamNo="+myTeamNo,
			type : 'GET',
			success : function() {
			},
			error : function() {
...
<!--    </ol> -->
   ...
   <input type="hidden" value="${myTeamNo}" id="myTeamNo" name="myTeamNo" />
               ...
               <div class="d-flex flex-row align-items-center">
                  ...
                  <div class="info-card-text flex-1">
                     ...
                     <div class="dropdown-menu">
                        <!-- 11.18 조준서 수정 -->
                        <a class="dropdown-item" onclick="overClick(${teamList.tst_team_no })">매칭 신청</a> 
                     </div>
