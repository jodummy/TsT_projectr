...
public interface TeamBoardMapper {
    ...
    * */
	 ...
	 * @param int tst_team_notice_board_no
	 * */
	public int noticeViewCount(TeamNoticeCheckVo noticeCheckVo) throws Exception;
	 ...
	 * @param int tst_team_no
	 * */
	public void noticeViewInsert(TeamNoticeCheckVo noticeCheckVo) throws Exception;
	
	/*
	 * 팀 공지사항 멤버들 조회수 업데이트(유진)
	 * 11.25
	 * @param int tst_team_notice_board_no
	 * */
	public void noticeViewUpdate(int tst_team_notice_board_no) throws Exception;
